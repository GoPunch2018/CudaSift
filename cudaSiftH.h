#ifndef CUDASIFT_CUDASIFTH_H
#define CUDASIFT_CUDASIFTH_H
...
void
ExtractSiftOctave(SiftData &siftData, CudaImage &img, int octave, float thresh, float edgeThreshold, float lowestScale, float subsampling,
                  float *memoryTmp);
