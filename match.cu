...
void CheckMatches(int *h_index, int *h_index2, float *h_score, float *h_score2) {
    ...
    for (int i = 0; i < NPTS; i++) {
        ...
        if (h_index[i] != h_index2[i])
            std::cout << "  " << i << " " << h_index[i] << " " << h_index2[i] << " " << h_score[i] << " " << h_score2[i]
                      << std::endl;
    }
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "MatchCPU2:   " << delay << " ms  " << 2.0*NPTS*NPTS*NDIM/delay/1024/1024 << " Gflops" << std::endl;
        ...
        delay = time.read() - ltime;
        std::cout << "MatchCPU3:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
                  << std::endl;
    }
    dim3 blocks, threads;
#if 0
  ...
  std::cout << "MatchGPU2:   " << delay << " ms  " << 2.0*NPTS*NPTS*NDIM/delay/1024/1024 << " Gflops" << std::endl;
    ...
    std::cout << "MatchGPU3:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
    ...
    std::cout << "MatchGPU4:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
    ...
    std::cout << "MatchGPU5:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
    ...
    std::cout << "MatchGPU6:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
    ...
    std::cout << "MatchGPU7:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
    ...
    std::cout << "MatchGPU8:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
#if 1
    blocks = dim3(NPTS / M7W);
    ...
    std::cout << "Match8small:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024 << " Gflops"
              << std::endl;
#endif
#if 1
    blocks = dim3(NPTS / M7W);
    ...
    std::cout << "MatchGPU8blocked:   " << delay << " ms  " << 2.0 * NPTS * NPTS * NDIM / delay / 1024 / 1024
              << " Gflops" << std::endl;
#endif
    ltime = time.read();
